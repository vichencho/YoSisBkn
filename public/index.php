...
/**
 * Establecer APP_AJAX
 * modificacion Vicente León 2015-08-13
 */
 ...
 * Define APP_CHARSET
 */
// define('APP_CHARSET', Config::get('config.application.charset'));
...
/**
 * Define el IMAGE_PATH
 *
 * IMAGE_PATH:
 * - Ruta al directorio 'public/img' 
 * - Esta ruta se utiliza para almacenar los archivos de imágenes 
 * - a compartir en la aplicación
 */
define('IMAGE_PATH', dirname(dirname(__FILE__)) . '/public/img/');
